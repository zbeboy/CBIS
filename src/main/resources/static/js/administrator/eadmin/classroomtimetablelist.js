 ...
 */
function toEdit(id){
    window.location.href = web_path + '/administrator/eadmin/classroomTimetableUpdate?id=' + id;
}
 ...
 */
function toLook(id){
    window.location.href = web_path + '/administrator/eadmin/classroomTimetableLook?id='+id;
}
