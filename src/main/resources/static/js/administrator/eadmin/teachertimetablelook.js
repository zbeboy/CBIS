...
var DEFAULT_URL = web_path + file_path;
...
(function () {
    ...
    (function (root, factory) {
        ...
        function configure(PDFJS) {
            PDFJS.imageResourcesPath = web_path + '/js/plugin/pdf/images/';
            PDFJS.workerSrc = web_path + '/js/plugin/pdf/pdf.worker.js';
            PDFJS.cMapUrl = web_path + '/js/plugin/pdf/cmaps/';
