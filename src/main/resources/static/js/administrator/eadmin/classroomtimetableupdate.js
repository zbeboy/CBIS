 ...
 */
var param = {
    'id': $('#classroomCourseTimetableId').val().trim(),
 ...
 */
function initParam() {
    param.id = $('#classroomCourseTimetableId').val().trim();
    ...
    param.classroom = $('#classroom').val().trim();
}
...
$(function () {
    ...
    $('#fileupload').fileupload({
        ...
        formData: {pathname: 'classroomtimetable'},
        dataType: 'json',
        send: function (e, data) {
            ...
            $('#filePath').val("/files/classroomtimetable/" + data.result.single.single.newName);
    ...
    $('#updateForm').validator({
        ...
        valid: function (form) {
            ...
            me.holdSubmit();
            $.ajax({
                url: web_path + "/administrator/eadmin/updateClassroomTimetable",
                data: param,
                type: "POST",
