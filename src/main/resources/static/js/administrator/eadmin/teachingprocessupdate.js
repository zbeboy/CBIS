 ...
 */
function initParam() {
    param.id = $('#teachProcessId').val().trim();
...
$(function () {
    ...
    /* nice validator*/
    $('#updateTeachingProcessForm').validator({
        stopOnError: false,
        ...
        valid: function (form) {
            ...
            initParam();
            $.ajax({
                url: web_path + "/administrator/eadmin/updateTeachingProcess",
                data: param,
                type: "POST",
                success: function (data) {
                    ...
                    if (data.state) {
                        layer.msg(data.msg, {icon: 1}, function () {
                            window.location.href = web_path + '/administrator/eadmin/teachingProcessList?teachType='+teachType;
                        });
                    } else {
                        layer.msg(data.msg);
                    }
