 ...
 */
function toEdit(id){
    window.location.href = web_path + '/administrator/eadmin/studentTimetableUpdate?id=' + id;
}
 ...
 */
function toLook(id){
    window.location.href = web_path + '/administrator/eadmin/studentTimetableLook?id='+id;
}
