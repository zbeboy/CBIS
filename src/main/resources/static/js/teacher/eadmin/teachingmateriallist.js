...
function action() {
    ...
    $.post(web_path + '/teacher/eadmin/teachingMaterialData', {
...
function startAP(obj) {
    ...
    var teachingMaterialInfoId = $(obj).attr('data-id');
    window.location.href = web_path + '/teacher/eadmin/teachingMaterialContentList?templateId=' + templateId + "&teachingMaterialInfoId="+teachingMaterialInfoId;
}