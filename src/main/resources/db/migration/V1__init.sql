...
create table teaching_material_template(
  id int not null primary key auto_increment,
  title varchar(50) not null,
  create_time TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  create_user varchar(64) not null,
...
create table teaching_material_info(
  id int not null primary key auto_increment,
  title varchar(100) not null,
  create_time TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  teaching_material_template_id int not null,
  start_time datetime not null,
  end_time datetime not null,
  users_id varchar(64) not null,
  tie_id int not null,
  foreign key(teaching_material_template_id) references teaching_material_template(id),
  foreign key(users_id) references users(username),
  foreign key(tie_id) references tie(id)
);

create table teaching_material_head(
  id int not null primary key auto_increment,
  title varchar(50) not null,
  title_variable varchar(50) not null,
  teach_task_title_id int,
...
create table teaching_material_content(
  id int not null primary key auto_increment,
  content varchar(500),
  teaching_material_head_id int not null,
  teacher_id int,
  content_x int not null,
...
create table examination_arrangement_template(
  id int not null primary key auto_increment,
  title varchar(50) not null,
  create_time TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  create_user varchar(64) not null,
...
create table examination_arrangement_info(
  id int not null primary key auto_increment,
  title varchar(100) not null,
  create_time TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  examination_arrangement_template_id int not null,
  start_time datetime not null,
  end_time datetime not null,
  users_id varchar(64) not null,
  tie_id int not null,
  foreign key(examination_arrangement_template_id) references examination_arrangement_template(id),
  foreign key(users_id) references users(username),
  foreign key(tie_id) references tie(id)
);

create table examination_arrangement_head(
  id int not null primary key auto_increment,
  title varchar(50) not null,
  title_variable varchar(50) not null,
  teach_task_title_id int,
...
create table examination_arrangement_content(
  id int not null primary key auto_increment,
  content varchar(500),
  examination_arrangement_head_id int not null,
  teacher_id int,
  content_x int not null,
  foreign key(examination_arrangement_head_id) references examination_arrangement_head(id)
);
