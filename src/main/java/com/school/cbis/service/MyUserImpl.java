 ...
 */
public class MyUserImpl implements UserDetails, CredentialsContainer {
    ...
    public boolean equals(Object rhs) {
        if (rhs instanceof MyUserImpl) {
            return username.equals(((MyUserImpl) rhs).username);
        }
        return false;
    }
    ...
    public String toString() {
        ...
        sb.append("UserTypeId: ").append(this.userTypeId).append("; ");
