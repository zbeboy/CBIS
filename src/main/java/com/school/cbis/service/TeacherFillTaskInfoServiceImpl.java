...
public class TeacherFillTaskInfoServiceImpl implements TeacherFillTaskInfoService {
    ...
    @Override
    public Result<Record7<Integer, String, Timestamp, String, Timestamp, Timestamp, String>> findByTieIdAndTeachTypeIdAndPage(TeacherFillTaskInfoListVo teacherFillTaskInfoListVo, int tieId) {
        Condition a = Tables.TEACHER_FILL_TASK_INFO.TIE_ID.eq(tieId).and(Tables.TEACH_TASK_INFO.TEACH_TYPE_ID.eq(teacherFillTaskInfoListVo.getTeachTypeId()));
    ...
    @Override
    public int findByTieIdAndTeachTypeIdAndPageCount(TeacherFillTaskInfoListVo teacherFillTaskInfoListVo, int tieId) {
        Condition a = Tables.TEACHER_FILL_TASK_INFO.TIE_ID.eq(tieId).and(Tables.TEACH_TASK_INFO.TEACH_TYPE_ID.eq(teacherFillTaskInfoListVo.getTeachTypeId()));
        if (StringUtils.hasLength(teacherFillTaskInfoListVo.getTitle())) {
            a = a.and(Tables.TEACHER_FILL_TASK_INFO.TITLE.like("%" + teacherFillTaskInfoListVo.getTitle() + "%"));
        }
