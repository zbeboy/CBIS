...
public class Keys {
	...
	public static final Identity<HeadTypePluginRecord, Integer> IDENTITY_HEAD_TYPE_PLUGIN = Identities0.IDENTITY_HEAD_TYPE_PLUGIN;
	...
	public static final UniqueKey<HeadTypePluginRecord> KEY_HEAD_TYPE_PLUGIN_PRIMARY = UniqueKeys0.KEY_HEAD_TYPE_PLUGIN_PRIMARY;
	...
	public static final ForeignKey<AutonomousPracticeHeadRecord, HeadTypeRecord> AUTONOMOUS_PRACTICE_HEAD_IBFK_1 = ForeignKeys0.AUTONOMOUS_PRACTICE_HEAD_IBFK_1;
	public static final ForeignKey<AutonomousPracticeHeadRecord, AutonomousPracticeInfoRecord> AUTONOMOUS_PRACTICE_HEAD_IBFK_2 = ForeignKeys0.AUTONOMOUS_PRACTICE_HEAD_IBFK_2;
	...
	public static final ForeignKey<AutonomousPracticeTemplateRecord, AutonomousPracticeInfoRecord> AUTONOMOUS_PRACTICE_TEMPLATE_IBFK_1 = ForeignKeys0.AUTONOMOUS_PRACTICE_TEMPLATE_IBFK_1;
	...
	public static final ForeignKey<HeadTypePluginRecord, HeadTypeRecord> HEAD_TYPE_PLUGIN_IBFK_1 = ForeignKeys0.HEAD_TYPE_PLUGIN_IBFK_1;
	...
	private static class Identities0 extends AbstractKeys {
		...
		public static Identity<HeadTypePluginRecord, Integer> IDENTITY_HEAD_TYPE_PLUGIN = createIdentity(HeadTypePlugin.HEAD_TYPE_PLUGIN, HeadTypePlugin.HEAD_TYPE_PLUGIN.ID);
	...
	private static class UniqueKeys0 extends AbstractKeys {
		...
		public static final UniqueKey<HeadTypePluginRecord> KEY_HEAD_TYPE_PLUGIN_PRIMARY = createUniqueKey(HeadTypePlugin.HEAD_TYPE_PLUGIN, HeadTypePlugin.HEAD_TYPE_PLUGIN.ID);
	...
	private static class ForeignKeys0 extends AbstractKeys {
		...
		public static final ForeignKey<AutonomousPracticeHeadRecord, HeadTypeRecord> AUTONOMOUS_PRACTICE_HEAD_IBFK_1 = createForeignKey(com.school.cbis.domain.Keys.KEY_HEAD_TYPE_PRIMARY, AutonomousPracticeHead.AUTONOMOUS_PRACTICE_HEAD, AutonomousPracticeHead.AUTONOMOUS_PRACTICE_HEAD.HEAD_TYPE_ID);
		public static final ForeignKey<AutonomousPracticeHeadRecord, AutonomousPracticeInfoRecord> AUTONOMOUS_PRACTICE_HEAD_IBFK_2 = createForeignKey(com.school.cbis.domain.Keys.KEY_AUTONOMOUS_PRACTICE_INFO_PRIMARY, AutonomousPracticeHead.AUTONOMOUS_PRACTICE_HEAD, AutonomousPracticeHead.AUTONOMOUS_PRACTICE_HEAD.AUTONOMOUS_PRACTICE_INFO_ID);
		...
		public static final ForeignKey<AutonomousPracticeTemplateRecord, AutonomousPracticeInfoRecord> AUTONOMOUS_PRACTICE_TEMPLATE_IBFK_1 = createForeignKey(com.school.cbis.domain.Keys.KEY_AUTONOMOUS_PRACTICE_INFO_PRIMARY, AutonomousPracticeTemplate.AUTONOMOUS_PRACTICE_TEMPLATE, AutonomousPracticeTemplate.AUTONOMOUS_PRACTICE_TEMPLATE.AUTONOMOUS_PRACTICE_INFO_ID);
		...
		public static final ForeignKey<HeadTypePluginRecord, HeadTypeRecord> HEAD_TYPE_PLUGIN_IBFK_1 = createForeignKey(com.school.cbis.domain.Keys.KEY_HEAD_TYPE_PRIMARY, HeadTypePlugin.HEAD_TYPE_PLUGIN, HeadTypePlugin.HEAD_TYPE_PLUGIN.HEAD_TYPE_ID);
