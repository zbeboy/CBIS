...
public class TeachingMaterialTemplate implements Serializable {
	...
	private static final long serialVersionUID = -1270732554;
	...
	public TeachingMaterialTemplate(TeachingMaterialTemplate value) {
		this.id = value.id;
	...
	public String toString() {
		StringBuilder sb = new StringBuilder("TeachingMaterialTemplate (");
