...
public class ExaminationArrangementTemplate implements Serializable {

	private static final long serialVersionUID = -422463508;
	...
	public ExaminationArrangementTemplate(ExaminationArrangementTemplate value) {
		this.id = value.id;
	...
	public String toString() {
		StringBuilder sb = new StringBuilder("ExaminationArrangementTemplate (");
