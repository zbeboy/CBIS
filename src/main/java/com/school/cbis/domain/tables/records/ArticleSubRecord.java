...
public class ArticleSubRecord extends UpdatableRecordImpl<ArticleSubRecord> implements Record5<Integer, String, String, String, Integer> {

	private static final long serialVersionUID = 492194456;
	 ...
	 */
	@Override
	public ArticleSubRecord values(Integer value1, String value2, String value3, String value4, Integer value5) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public ArticleSubRecord(Integer id, String subTitle, String subContent, String subPhotoUrl, Integer articleInfoId) {
		super(ArticleSub.ARTICLE_SUB);
