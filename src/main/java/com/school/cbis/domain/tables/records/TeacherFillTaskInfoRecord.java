...
public class TeacherFillTaskInfoRecord extends UpdatableRecordImpl<TeacherFillTaskInfoRecord> implements Record8<Integer, String, Timestamp, Integer, Timestamp, Timestamp, String, Integer> {

	private static final long serialVersionUID = 272027362;
	 ...
	 */
	@Override
	public TeacherFillTaskInfoRecord values(Integer value1, String value2, Timestamp value3, Integer value4, Timestamp value5, Timestamp value6, String value7, Integer value8) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public TeacherFillTaskInfoRecord(Integer id, String title, Timestamp createTime, Integer teacherFillTaskTemplateId, Timestamp startTime, Timestamp endTime, String usersId, Integer tieId) {
		super(TeacherFillTaskInfo.TEACHER_FILL_TASK_INFO);
