...
public class PersistentLoginsDao extends DAOImpl<PersistentLoginsRecord, com.school.cbis.domain.tables.pojos.PersistentLogins, String> {

	/**
	 * Create a new PersistentLoginsDao without any configuration
	 */
	public PersistentLoginsDao() {
		super(PersistentLogins.PERSISTENT_LOGINS, com.school.cbis.domain.tables.pojos.PersistentLogins.class);
	}
	...
	public PersistentLoginsDao(Configuration configuration) {
		super(PersistentLogins.PERSISTENT_LOGINS, com.school.cbis.domain.tables.pojos.PersistentLogins.class, configuration);
	}
	 ...
	 */
	@Override
	protected String getId(com.school.cbis.domain.tables.pojos.PersistentLogins object) {
	 ...
	 */
	public List<com.school.cbis.domain.tables.pojos.PersistentLogins> fetchByUsername(String... values) {
	 ...
	 */
	public List<com.school.cbis.domain.tables.pojos.PersistentLogins> fetchBySeries(String... values) {
	 ...
	 */
	public com.school.cbis.domain.tables.pojos.PersistentLogins fetchOneBySeries(String value) {
	 ...
	 */
	public List<com.school.cbis.domain.tables.pojos.PersistentLogins> fetchByToken(String... values) {
	 ...
	 */
	public List<com.school.cbis.domain.tables.pojos.PersistentLogins> fetchByLastUsed(Timestamp... values) {
