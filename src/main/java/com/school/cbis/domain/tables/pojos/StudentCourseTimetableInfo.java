...
public class StudentCourseTimetableInfo implements Serializable {

	private static final long serialVersionUID = -1193694690;
	...
	public StudentCourseTimetableInfo(StudentCourseTimetableInfo value) {
		this.id = value.id;
	...
	public String toString() {
		StringBuilder sb = new StringBuilder("StudentCourseTimetableInfo (");
