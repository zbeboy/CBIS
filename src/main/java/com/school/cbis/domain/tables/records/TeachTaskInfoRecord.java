...
public class TeachTaskInfoRecord extends UpdatableRecordImpl<TeachTaskInfoRecord> implements Record11<Integer, Integer, String, String, String, Timestamp, String, Integer, Integer, Date, Date> {

	private static final long serialVersionUID = 400100540;
	 ...
	 */
	@Override
	public Row11<Integer, Integer, String, String, String, Timestamp, String, Integer, Integer, Date, Date> fieldsRow() {
	 ...
	 */
	@Override
	public Row11<Integer, Integer, String, String, String, Timestamp, String, Integer, Integer, Date, Date> valuesRow() {
	 ...
	 */
	@Override
	public TeachTaskInfoRecord values(Integer value1, Integer value2, String value3, String value4, String value5, Timestamp value6, String value7, Integer value8, Integer value9, Date value10, Date value11) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public TeachTaskInfoRecord(Integer id, Integer tieId, String teachTaskFileUrl, String teachTaskFileSize, String teachTaskFileName, Timestamp teachTaskFileDate, String teachTaskTerm, Integer teachTaskDownTimes, Integer teachTypeId, Date termStartTime, Date termEndTime) {
		super(TeachTaskInfo.TEACH_TASK_INFO);
