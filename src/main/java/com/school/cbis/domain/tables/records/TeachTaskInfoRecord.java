...
public class TeachTaskInfoRecord extends UpdatableRecordImpl<TeachTaskInfoRecord> implements Record21<Integer, Integer, String, String, String, Timestamp, String, Integer, Integer, Date, Date, String, String, Integer, Integer, Integer, Integer, Integer, Integer, Byte, Byte> {

	private static final long serialVersionUID = 771748;
	...
	/**
	 * Setter for <code>cbis.teach_task_info.is_ok</code>. 是否系上已确认
	 */
	...
	/**
	 * Getter for <code>cbis.teach_task_info.is_ok</code>. 是否系上已确认
	 */
	@NotNull
	public Byte getIsOk() {
	 ...
	 */
	@Override
	public Row21<Integer, Integer, String, String, String, Timestamp, String, Integer, Integer, Date, Date, String, String, Integer, Integer, Integer, Integer, Integer, Integer, Byte, Byte> fieldsRow() {
	 ...
	 */
	@Override
	public Row21<Integer, Integer, String, String, String, Timestamp, String, Integer, Integer, Date, Date, String, String, Integer, Integer, Integer, Integer, Integer, Integer, Byte, Byte> valuesRow() {
	...
	public Field<Byte> field21() {
		return TeachTaskInfo.TEACH_TASK_INFO.IS_OK;
	}
	 ...
	 */
	@Override
	public TeachTaskInfoRecord value21(Byte value) {
		setIsOk(value);
		return this;
	}
