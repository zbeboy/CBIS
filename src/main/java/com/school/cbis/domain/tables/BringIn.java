...
public class BringIn extends TableImpl<BringInRecord> {
	...
	private static final long serialVersionUID = 676353037;
	 ...
	 */
	public final TableField<BringInRecord, Integer> RELEASE_ARTICLE_ARTICLE_INFO_ID = createField("release_article_article_info_id", org.jooq.impl.SQLDataType.INTEGER, this, "");
	...
	public List<ForeignKey<BringInRecord, ?>> getReferences() {
		return Arrays.<ForeignKey<BringInRecord, ?>>asList(Keys.BRING_IN_IBFK_1);
	}
