...
public class EAdminController {
    ...
    public String assignmentBookList(AssignmentBookListVo assignmentBookListVo, ModelMap modelMap) {
        ...
        log.info(" users : {}",usersService.getUserInfoBySession());
    ...
    @RequestMapping("/teacher/eadmin/teacherFillTemplateAdd")
    public String teacherFillTemplateAdd() {
        return "/teacher/eadmin/teacherfilltemplateadd";
    }
